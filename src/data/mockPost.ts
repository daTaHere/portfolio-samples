...
export const mockPost = [
  ...
  },
  {
    ...
    type: 'backend',
    media: {
      mainImg: 'https://www.python.org/static/community_logos/python-logo.png',
      slides: [
  ...
  },
  {
    id: 12,
    title: 'Angular',
    content: 'Angular is a platform for building mobile and desktop web apps.',
    author: {
      id: 3,
      firstName: 'Alice',
      lastName: 'Johnson',
    ...
    type: 'frontend',
    media: {
      mainImg: 'https://angular.io/assets/images/logos/angular/angular.png',
      slides: [
  ...
  },
  {
    id: 13,
    title: 'SQL Server',
    content: 'Microsoft SQL Server is a relational database management system.',
    author: {
      id: 1,
      firstName: 'John',
      lastName: 'Doe',
  ...
  },
  {
    id: 14,
    title: 'PostgreSQL',
    content: 'PostgreSQL is an open-source object-relational database system.',
    author: {
      id: 11,
      firstName: 'Olivia',
      lastName: 'Pope',
    ...
    type: 'backend',
    media: {
      mainImg: 'https://www.postgresql.org/media/img/about/press/elephant.png',
      slides: [
  ...
  },
  {
    id: 15,
    title: 'Vite',
    content: 'Vite is a fast frontend build tool for modern web projects.',
    author: {
      id: 17,
      firstName: 'Mark',
      lastName: 'Twain',
  ...
  },
  {
    id: 17,
    title: 'TypeScript',
    content: 'TypeScript adds types to JavaScript for better maintainability.',
    author: {
      id: 2,
      firstName: 'Jane',
      lastName: 'Smith',
